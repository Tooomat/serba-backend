...
export const timeUtils = {
    ...
    parseDateToDay(date: Date | null): string | null{
        if (date === null) {
            return null
        }
    ...
    countStartDateToEndDate(startDate: Date, endDate: Date): string | null {
    ...
    getTimeAgo(date: Date | null, locale: Locale = 'en'): string | null{
        if (date === null) {
            return null
        }
        const now = new Date()
