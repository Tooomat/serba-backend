...
export class SubDistrictsController {
    static async get(req: AuthRequest, res: Response, next: NextFunction) {
        try {
            const subdistrictId = String(req.params.subDistrictId)
            

            const result = await SubDistrictsService.get(subdistrictId)
    ...
    static async getByDistrict(req: AuthRequest, res: Response, next: NextFunction) {
        try {
            ...
            const results = await SubDistrictsService.getByDistrict(districtId)
